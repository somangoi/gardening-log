...
![HMR을 위해 웹소켓이 요청과 응답을 하고 있다는 것을 network 탭에서 확인할 수 있다.](./image1.png)
...
![HMR을 위해 웹소켓이 연결되면 네트워크 탭에서 주기적으로 ping을 보내는 것을 확인할 수 있다.](./image2.png)
...
![nextJS로 작성된 웹앱에서 개발서버를 동작시키면 웹소켓을 통해 HMR이 실행되는 것을 알 수 있다.](./image3.png)
